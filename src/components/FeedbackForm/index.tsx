...
export const FormularioFeedback: React.FC = () => {
  ...
  return (
    <S.Form onSubmit={handleSubmit}>
      <label>
        ...
        <InputComponent type="text" name="nome" value={dadosFormulario.nome} onChange={handleChange} />
      </label>
      <label>
        Anônimo:
      ...
      <Button text="Enviar" to="">Enviar</Button>
    </S.Form>
  );
};
